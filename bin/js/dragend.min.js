    ...
    function b(a) {
        ...
        function l(a, b) {
            ...
            this.settings = g(d, b), this.container = a, this.pageContainer = c.createElement("div"), this.scrollBorder = {
                ...
                this.pageContainer.innerHTML = a.cloneNode(!0).innerHTML, a.innerHTML = "",
                a.appendChild(this.pageContainer), this._scroll = x ? this._scrollWithTransform : this._scrollWithoutTransform, this._animateScroll = x ? this._animateScrollWithTransform : this._animateScrollWithoutTransform,
                f(a, v),
